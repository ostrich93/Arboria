...
namespace Arboria {
	...
	HashTable<uint32_t, String> indexToSpriteFilenames = {
		...
		{30, "gui/keys/keyboard_0.png"},
		{31, "gui/keys/keyboard_1.png"},
		{32, "gui/keys/keyboard_2.png"},
		{33, "gui/keys/keyboard_3.png"},
		{34, "gui/keys/keyboard_4.png"},
		{35, "gui/keys/keyboard_5.png"},
		{36, "gui/keys/keyboard_6.png"},
		{37, "gui/keys/keyboard_7.png"},
		{38, "gui/keys/keyboard_8.png"},
		{39, "gui/keys/keyboard_9.png"},
		...
		{50, "gui/keys/keyboard_semicolon.png"},
		{51, "gui/keys/keyboard_apostrophe.png"},
		{52, "gui/keys/keyboard_tilde.png"},
		{53, "gui/keys/keyboard_comma.png"},
		{54, "gui/keys/keyboard_period.png"},
		{55, "gui/keys/keyboard_slash_forward.png"},
		{56, "gui/keys/keyboard_capslock.png"},
		{57, "gui/keys/keyboard_f1.png"},
		{58, "gui/keys/keyboard_f2.png"},
		{59, "gui/keys/keyboard_f3.png"},
		{60, "gui/keys/keyboard_f4.png"},
		{61, "gui/keys/keyboard_f5.png"},
		{62, "gui/keys/keyboard_f6.png"},
		{63, "gui/keys/keyboard_f7.png"},
		{64, "gui/keys/keyboard_f8.png"},
		{65, "gui/keys/keyboard_f9.png"},
		{66, "gui/keys/keyboard_f10.png"},
		{67, "gui/keys/keyboard_f11.png"},
		{68, "gui/keys/keyboard_f12.png"},
		{81, "gui/keys/keyboard_printscreen.png"},
		{85, "gui/keys/keyboard_home.png"},
		{86, "gui/keys/keyboard_page_up.png"},
		{87, "gui/keys/keyboard_page_down.png"},
		{88, "gui/keys/keyboard_delete.png"},
		{89, "gui/keys/keyboard_end.png"},
		{90, "gui/keys/keyboard_arrow_left.png"},
		{91, "gui/keys/keyboard_arrow_right.png"},
		{92, "gui/keys/keyboard_arrow_up.png"},
		{93, "gui/keys/keyboard_arrow_down.png"},
		{94, "gui/keys/keyboard_numlock.png"},
		{113, "gui/keys/keyboard_ctrl.png"},
		{114, "gui/keys/keyboard_shift.png"},
		{115, "gui/keys/keyboard_alt.png"},
		{117, "gui/keys/keyboard_ctrl.png"},
		{118, "gui/keys/keyboard_shift.png"},
		{119, "gui/keys/keyboard_alt.png"},
