...
namespace Arboria {
	...
	SystemConfig::SystemConfig()
	{
		...
		defaultWindowScale = new CVariable("defaultWindowScale", "2", CVAR_INTEGER | CVAR_CONFIG | CVAR_ENGINE | CVAR_FROMENGINE, "" );
		...
		windowScale = new CVariable("windowScale", "2", CVAR_INTEGER | CVAR_CONFIG | CVAR_ENGINE | CVAR_FROMENGINE, "");
